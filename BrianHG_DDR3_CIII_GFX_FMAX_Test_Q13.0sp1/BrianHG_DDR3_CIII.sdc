...
set_output_delay -clock [get_clocks {u_vpg|u_pll|altpll_component|auto_generated|pll1|clk[0]}] -max $tCO  [get_ports {HDMI*}]
set_output_delay -clock [get_clocks {u_vpg|u_pll|altpll_component|auto_generated|pll1|clk[0]}] -min $tCOm [get_ports {HDMI*}]
...
set_false_path -from [get_clocks {u_vpg|u_pll|altpll_component|auto_generated|pll1|clk[0]}] -to [get_clocks {CLK_IN_50}]

# Separate the fake generated I2C clock output from the CLK_IN 50 MHz source.
set_false_path -from [get_clocks {u_I2C_HDMI_Config|mI2C_CTRL_CLK|q}] -to [get_clocks {u_vpg|u_pll|altpll_component|auto_generated|pll1|clk[0]}]

# Optional: Separate the reset and low frequency inputs on the CLK_IN 50Mhz from the core.
set_false_path -from [get_clocks {CLK_IN_50}] -to [get_clocks {*DDR3_PLL5*clk[4]}]
set_false_path -from [get_clocks {*DDR3_PLL5*clk[4]}] -to [get_clocks {CLK_IN_50}]
